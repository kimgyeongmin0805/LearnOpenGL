...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		lightColor.z = static_cast<float>(sin(glfwGetTime() * 1.2));
		objectShader.setVec3("light.ambient", glm::vec3(0.1f) * lightColor);
		objectShader.setVec3("light.diffuse", glm::vec3(0.5f) * lightColor);
		objectShader.setVec3("light.specular", glm::vec3(1.0f, 1.0f, 1.0f));
		objectShader.setVec3("viewPos", camera.Position);
		objectShader.setVec3("material.ambient", glm::vec3(1.0f, 0.5f, 0.3f));
		objectShader.setVec3("material.diffuse", glm::vec3(1.0f, 0.5f, 0.3f));
